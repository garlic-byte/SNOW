...
from snow.model.modules import SnowActionHead, DriftActionHead, SingleEmbodimentActionHead
...
class SnowModel(PreTrainedModel):
    ...
    def __init__(self, config: SnowConfig):
        ...
        self.action_head = SingleEmbodimentActionHead(config).to(dtype=self.backbone.dtype)
